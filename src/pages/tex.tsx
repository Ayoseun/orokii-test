import React, {createRef, DOMAttributes, Ref, useEffect, useRef, useState} from "react";
...
const Selfie = (props: {}) => {
    ...
    useEffect(() => {
        if (!componentMounted) {
            ...
            if (isWidgetCaptureStarted) {
                ...
                node?.addEventListener("onLivenessErrorButtonClick", onLivenessErrorButtonClick)
    ...
    function onTrackStatus(eventData: any) {
        let trackStatusCode: any = Object.entries(FPhi.Selphi.TrackStatus).find((e: any) => e[1] === eventData.detail.code);
            ...
            <div className="row h-100">
                ...
                <div className="col-12 col-md-3 mt-3 mt-md-0">
                    <div className="form-group">
                        ...
                        <select id="widgetLivenessMode" className="form-control" value={widgetLivenessMode}
                                onChange={(e: any) => setWidgetLivenessMode(e.target.value)} disabled={isWidgetCaptureStarted}>
                    ...
                    <div className="form-group form-check m-0">
                        <input type="checkbox" id="widgetInteractible" className="form-check-input"
                               checked={widgetInteractible} onChange={e => setWidgetInteractible(e.target.checked) } disabled={isWidgetCaptureStarted}/>
                        <label htmlFor="widgetInteractible" className="form-check-label">Interactible</label>
                    </div>
                    <div className="form-group form-check m-0">
                        <input type="checkbox" id="widgetTutorial" className="form-check-input"
                               checked={widgetTutorial} onChange={e => setWidgetTutorial(e.target.checked)} disabled={isWidgetCaptureStarted}/>
                        <label htmlFor="widgetTutorial" className="form-check-label">Tutorial</label>
                    </div>
                    <div className="form-group form-check m-0">
                        <input type="checkbox" id="widgetStabilizationStage" className="form-check-input"
                               checked={widgetStabilizationStage} onChange={e => setWidgetStabilizationStage(e.target.checked)} disabled={isWidgetCaptureStarted}/>
                        <label htmlFor="widgetStabilizationStage" className="form-check-label">Stabilization Stage</label>
                    </div>
                    <div className="form-group form-check m-0">
                        <input type="checkbox" id="widgetVideoRecord" className="form-check-input"
                               checked={widgetVideoRecord} onChange={e => setWidgetVideoRecord(e.target.checked)} disabled={isWidgetCaptureStarted}/>
                        <label htmlFor="widgetVideoRecord" className="form-check-label">Record video session</label>
                    </div>
                    {/* <div className="form-group form-check m-0">
                    ...
                    <div className="form-group form-check m-0">
                        <input type="checkbox" id="widgetShowLog" className="form-check-input"
                               checked={widgetShowLog} onChange={e => setWidgetShowLog(e.target.checked)} disabled={isWidgetCaptureStarted}/>
                        <label htmlFor="widgetShowLog" className="form-check-label">Show extended log</label>
                    </div>
                    <div className="form-group form-check">
                        <input type="checkbox" id="widgetDebugMode" className="form-check-input"
                               checked={widgetDebugMode} onChange={e => setWidgetDebugMode(e.target.checked)} disabled={isWidgetCaptureStarted}/>
                    ...
                    <div className="form-group">
                        ...
                        <select id="widgetCameraResolution" className="form-control"
                                value={widgetCameraResolution} onChange={onCameraResolutionChanged}
                    ...
                    <div className="form-group">
                        ...
                        <select id="widgetCameraType" className="form-control" value={widgetCameraType}
                                onChange={(e: any) => setWidgetCameraType(e.target.value)} disabled={isWidgetCaptureStarted}>
